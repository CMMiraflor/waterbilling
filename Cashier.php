...
<div class ="inputs">
        ...
        <div class="wrapsearchtxt">
            ...
            <div class="wrapf">
             Name: <input type = "text" name="fullname" id="fullname" class="searchTerm" placeholder="Name" readonly>
            ...
            <div class="wrapprev">
            Previous_Reading: <input type = "text" name="prev_reading" id="prev_reading" class="searchTerm" placeholder="Previous_Reading" readonly>
             <br>
             </div>

             <div class="wrapcurr">
            Current_Reading: <input type = "text" name="curr_reading" id="curr_reading" class="searchTerm" placeholder="Current_Reading" readonly>
             <br>
             </div>
             <div class="wrapcash">
          CASH: <input type = "number" name="cash" id="cash" oninput="myFunction()"  class="searchTermCash" placeholder="CASH">
             <br>
            
             </div>
             <div class="wrapPay">
          <input type = "submit" name="pay" id="pay" class="searchTermCash" value="BILLS PAYMENT">
             <br>
        ...
        <?php echo $message; ?>
             ...
             <div class="wrapconsumption">
             Water Consumption: <input type = "text" name="wconsumption" id="wconsumption" class="searchTerm" placeholder="Water Consumption" readonly>
            </div>
            <div class="wrapmemberfee">
             Membership Fee: <input type = "text" name="mfee" id="mfee" class="searchTerm" placeholder="Membership Fee" readonly>
            </div>
            <div class="wrappenalty">
             Penalty: <input type = "text" name="penalty" id="penalty" class="searchTerm" placeholder="Penalty" readonly>
            </div>
            <div class="ltotal">
            <label class="tl">TOTAL: </label>
            </div>
            <div class="wraptotal">
           <input type = "text" name="total" id="total" class="searchTermTotal" placeholder="TOTAL" readonly>
             <br>
             </div>
             <div class="lchange">
           ...
           <input type = "text" name="change" id="change" class="searchTermChange" placeholder="CHANGE" readonly>
             <br>
             </div>
...
$penalty = $referenceMember->getChild('Penalty')->getValue();
         ...
         <td><?php echo $lastnameT,$space, $firstnameT; ?></td>
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
        table.rows[i].onclick = function()
        {
         ...
         document.getElementById("consumer_ID").value = this.cells[0].innerHTML;
            ...
            document.getElementById("total").value = bal;
