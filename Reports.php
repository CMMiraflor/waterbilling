...
<div class="defQlist">
<input type = "submit" name="showdefQ" class="defQ" onclick="openFormDefQR()" value="Defective QR List">
</div> 
<div class="defMlist">
<input type = "submit" name="showdefQ" class="defQ" onclick="openFormDefMeter()" value="Defective Meter List">
</div>

<div class="memberlist">
   <input type = "submit" name="showMemList" class="memlist" onclick="openForm()" value="Member List">
   
</div>

<div class="paidlist">
   <input type = "submit" name="showPList"onclick="openFormPaid()"class="Plist" value="Paid">
   
</div>


<div class="notpaidlist">
   <input type = "submit" name="showPList" onclick="openFormUnpaid()" class="NPlist" value="Unpaid">

   
</div>

<div class="disconnectedlist">
   <input type = "submit" name="showPList" onclick="openFormDisconnected()" class="Dlist" value="Disconnected">
